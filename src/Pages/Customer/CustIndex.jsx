...
function CustIndex() {
  ...
  const { global, userInfo, toasterBool } = UseFetchLogger();
  ...
  return (
    <Grid container mt={5} ml={3} columnGap={2.5} rowGap={1}>
      ...
      {/* {scrid.length === 1 ? (
        <>
          ...
          <Grid item sm={12} xs={12} md={5.7} lg={5.8}>
            <CustPaymentHistory scrid={scrid[0]} />
          </Grid>
          <Grid item sm={12} xs={12} md={5.7} lg={5.8}>
            <MonthlyPayment scrid={scrid[0]} />
          </Grid>
        </>
      ) : null} */}
    </Grid>
