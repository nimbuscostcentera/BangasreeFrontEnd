...
function InspectEditCustomerData() {
  ...
  //     hideable: false,
  //     renderCell: (item) => {
  //       return <text>{moment(item.row.CollDate).format("DD/MM/YYYY")}</text>;
  //     },
  //   },
  //   {
  //     field: "totcolection",
  ...
  return (
    <ThemeProvider theme={CustomTheme}>
      <Grid container maxWidth={"xxxl"} color={"#000000"} ml={3} mt={5}>
        ...
        <Grid item xs={12} sm={12} md={12} lg={12} color={"black"} mt={1}>
          {" "}
          <Divider />
          <BiSepBox>
