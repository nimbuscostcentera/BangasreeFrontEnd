...
import PictureInspection from "../../Components/Global/PictureInspection";
...
function InspectEditAgentData() {
  ...
  //   if (pay[0]?.AgentCode == data?.AgentCode)
  //   {
  //     if (pay?.length !== 0)
  //     {
  //       return pay;
  ...
  //     }
  //   }
  // }, [isSuccess12, AgentID, data?.AgentCode, pay]);
  ...
  return (
    <ThemeProvider theme={CustomTheme}>
      <Grid container maxWidth={"Big"} mt={5} ml={3}>
        <Modal
          open={open}
          onClose={handleClose}
        ...
        <Grid item xs={12} sm={12} md={12} lg={12} mt={2}>
          ...
          <Divider sx={{ color: "black" }}>Personal Details</Divider>
        </Grid>
        <Grid item xs={12} sm={12} md={12} lg={12}>
          <Box
            component={"form"}
